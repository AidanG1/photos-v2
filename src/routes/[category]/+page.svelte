<script lang="ts">
	...
	import { categoryMenuBar, makeAltText } from '$lib/utils'
	import { page } from '$app/state'
	import SvelteMasonry from '$lib/components/SvelteMasonry.svelte'
...
<div class="flex justify-center p-2">
	<h1 class="text-4xl font-bold">{categoryMenuBar(data.category)}</h1>
</div>
<!-- <FancyMasonry photos={data.photos} /> -->
<!-- <TailwindMasonry photos={data.photos} category={data.category} /> -->
<SvelteMasonry images={data.photos} category={data.category} />
